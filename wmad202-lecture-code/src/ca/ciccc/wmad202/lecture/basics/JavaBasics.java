...
public class JavaBasics {
    ...
    public static void isPersonalAlowedToTheClub(){
    ...
    public static void evaluate(int grade){
        if(grade>=80){
            ...
            System.out.printf("You got a passing frade %d\n", grade);
        }else{
            System.out.printf("You faild a passing grade %d\n", grade);
        }
    }

    //while
    public static float calculationAverage(){
    ...
    public static void workingWithDivision(){
        ...
        System.out.println(num1/(int)num3);
    }
